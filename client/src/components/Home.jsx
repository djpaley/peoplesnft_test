                ...
                <div className="container align-self-center">
                    <div className="row justify-content-center">
                        <div className="col-12 col-lg-8 text-center">
                            ...
                            {currentAccount ? <button className="btn btn-light btn-lg" disabled>Whitelisted</button> : <button className="btn btn-light btn-lg" onClick={connectWallet}>Get Whitelisted</button>}
